...
import static com.bobgenix.datetimedialog.AndroidUtilities.createFrame;
import static com.bobgenix.datetimedialog.AndroidUtilities.createSimpleSelectorRoundRectDrawable;
...
public class BottomSheet extends Dialog {
    ...
    public static class BottomSheetCell extends FrameLayout {
        ...
        public BottomSheetCell(Context context, int type) {
            ...
            imageView.setColorFilter(new PorterDuffColorFilter(0xff676b70, PorterDuff.Mode.MULTIPLY));
            addView(imageView, createFrame(56, 48, Gravity.CENTER_VERTICAL | Gravity.LEFT));
            ...
            if (type == 0) {
                ...
                addView(textView, createFrame(WRAP_CONTENT, WRAP_CONTENT, Gravity.LEFT | Gravity.CENTER_VERTICAL));
            } else if (type == 1) {
        ...
        public void setTextAndIcon(CharSequence text, int icon, Drawable drawable, boolean bigTitle) {
            ...
            if (icon != 0 || drawable != null) {
                ...
                if (bigTitle) {
                    textView.setPadding(AndroidUtilities.dp(72), 0, AndroidUtilities.dp( 21), 0);
                    imageView.setPadding(AndroidUtilities.dp(5), 0, 5, 0);
                } else {
                    textView.setPadding(AndroidUtilities.dp(72), 0, AndroidUtilities.dp( 16), 0);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        container.addView(containerView, 0, createFrame(MATCH_PARENT, WRAP_CONTENT, Gravity.BOTTOM));
        ...
        if (title != null) {
            ...
            containerView.addView(titleView, createFrame(MATCH_PARENT, 48));
        ...
        if (customView != null) {
            ...
            containerView.addView(customView, createFrame(MATCH_PARENT, WRAP_CONTENT, Gravity.LEFT | Gravity.TOP, 0, topOffset, 0, 0));
        } else {
            if (items != null) {
                ...
                for (int a = 0; a < items.length; a++) {
                    ...
                    containerView.addView(cell, createFrame(MATCH_PARENT, 48, Gravity.LEFT | Gravity.TOP, 0, topOffset, 0, 0));
                    topOffset += 48;
                    cell.setTag(a);
